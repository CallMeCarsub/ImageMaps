...
public class ItemBuilder {
    ...
    public ItemBuilder addEnchant(Enchantment enchantment, int level, boolean allowUnsafe) {
     ...
     * @param key The key to set the tag by. Will replace any current key with the same name.
     */
    public <T, Z> ItemBuilder addPersistentData(Plugin plugin, String key, PersistentDataType<T, Z> type, Z object) {
     ...
     *                                  method.
     */
    public ItemBuilder removePersistentData(Plugin plugin, String key) {
        NamespacedKey k = NamespacedKey.fromString(key, plugin);
